...
void main() {
  ...
  var gestionBonEntree = EntreBon();
  // Instancier des objets Fournisseur
  fournisseursList = [
    Fournisseur(1, 'Fournisseur 1', 'Adresse 1', '111-1111'),
    Fournisseur(2, 'Fournisseur 2', 'Adresse 2', '222-2222'),
    Fournisseur(3, 'Fournisseur 3', 'Adresse 3', '333-3333'),
  ];
  utilisateurs = [
    Utilisateur(1, "Alice", "dd", "ds", "jf", Role.administrateur),
    Utilisateur(2, "Bob", "dd", "ds", "jf", Role.administrateur),
  ];
  ajouterFournisseur(Fournisseur(1, "nom", "adresse", "telephone"));
  // Initialiser la gestion des bons d'entrée
  // Ajouter un bon d'entrée
  afficherFournisseur(fournisseursList);
  // gestionBonEntree.ajouterUtilisateur();
  gestionBonEntree.afficherListeUtilisateurs(utilisateurs);
  gestionBonEntree.ajouterBonEntree(utilisateurs, fournisseursList);

  // Afficher tous les bons d'entrée
}
